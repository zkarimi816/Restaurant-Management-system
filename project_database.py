...
# import pandas as pd
#
# data = pd.read_excel(r'C:\Users\Aliahmad Karimi\Downloads\AUAF.xlsx')
# ## I am using my brothers laptop cause my own laptop is damaged (Zahra Karimi)
# s1 = data['Spring 2019'].values.tolist()
# s2 = data['Spring 2020'].values.tolist()
#
# plt.bar(s1,s2, color= 'green', label="Spring 2019")
# plt.xlabel("Major")
# plt.ylabel("Total Students")
# plt.title("AUAF Major VS Total Student")
# plt.legend()
# plt.show()
...
#                                                      gender varcahr(50) not null,
#                                                      password varchar(30) not null,
#                                                      confirm_password varchar(30) not null)''')
#     # name = self.username_signup.text()
#     # email = self.useremail_signup.text()
#     # gender = self.btnstate();
#     # password = self.password_signup.text()
#     # cpassword = self.cpassword_signup.text()
#     conn.execute('''insert into users(username, email,gender,password,confirm_password) values('Alisina Karimi','akarimi@gmail.com','male',123,123)''')
#     conn.commit()
#     conn.close()
# create_database()
from tkinter import*
